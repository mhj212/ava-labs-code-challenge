    ...
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          "h-[80px]", // fixed closed height
          className
        )}
        {...props}
      >
        {children}
        <ChevronDownIcon className="relative right-[25px] text-muted-foreground pointer-events-none w-4 h-4 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
